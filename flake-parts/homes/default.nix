...
in {
  ...
  config = {
    flake.homeConfigurations = {
      "lisa@asterion" = mkHome "aarch64-linux" config.flake.modules.homeManager."lisa@asterion";
    ...
    flake.checks = {
      aarch64-linux."home-lisa@asterion" = config.flake.homeConfigurations."lisa@asterion".activationPackage;
