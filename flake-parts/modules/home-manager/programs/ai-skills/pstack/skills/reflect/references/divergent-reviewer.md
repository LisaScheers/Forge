...
- Reads of any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.codex/skills/`, or Codex plugin cache paths)
- `collaboration.spawn_agent` prompts that name a skill path
