...
description: "Use when debugging. Trace each symptom to its root cause and fix it there; reproduce first, ask why until you reach it, resist nil-check guards that silence crashes."
---
...
**Pattern:**
- Reproduce first when the environment permits it. Otherwise establish the failure with the strongest available test, trace, log, or captured artifact.
