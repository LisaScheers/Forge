...
description: "Use when introducing a new internal API while old callers still exist. Migrate callers and delete the old API in the same wave instead of preserving compatibility layers."
---
...
Apply this only to internal APIs whose callers are all in scope. Preserve public or external compatibility unless the user explicitly approves a breaking change and migration plan.
