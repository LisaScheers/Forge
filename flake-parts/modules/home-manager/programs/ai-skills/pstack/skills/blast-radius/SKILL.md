---
name: blast-radius
description: "Use only when the user asks for a blast-radius analysis, asks what a change could break, or explicitly requests extra verification of a diff they do not trust."
---
...
5. Prove the one fact. Write a scratch script or test that runs the real code, run it, and paste what happened. Put it in the repository only when the user asked for a lasting test. If you can't prove it cheaply, mark it unproven. Don't round up.
6. For a big or wide change, use `$arena` only when the user asked for parallel or independent review.
