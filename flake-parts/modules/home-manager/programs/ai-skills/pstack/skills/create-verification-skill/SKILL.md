...
If the checkout doesn't build or start as-is, report that precisely. Fix product code only when the user also asked for the repair. A skill written against a broken base teaches wrong steps.
