...
4. [Design the change](./04-design.md). Use `/architect` for consequential boundary decisions and the multi-agent skills when independent attempts or coverage justify them.
