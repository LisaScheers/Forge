...
**Pattern:**
- **Isolate large payloads.** When delegation is authorized, route verbose outputs, screenshots, and large documents to subagents. The main context gets summaries, not raw data.
