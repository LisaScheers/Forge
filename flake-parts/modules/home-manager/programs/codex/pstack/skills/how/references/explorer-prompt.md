...
Start by finding the relevant code. Prefer `rg --files` for directories and files and `rg` for key symbols, then read the actual implementation. Don't guess from names.
