...
Allow intermediate breakage only in an isolated branch or worktree when the user authorized the migration. Keep daily-driver and production paths working unless the user explicitly permits otherwise.
